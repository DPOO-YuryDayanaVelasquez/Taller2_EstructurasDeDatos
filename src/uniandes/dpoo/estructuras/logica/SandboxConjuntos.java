...
public class SandboxConjuntos
{
    ...
    {
        NavigableSet<String> coleccionNueva = new TreeSet<>();
        
        for(String c : arbolCadenas) {
        	if (c.compareTo(cadena) >=0) {
        		coleccionNueva.add(c);
        	}
        }
    ...
    public void reiniciarConjuntoCadenas( List<Object> objetos )
    {
    	...
    	for(Object objeto: objetos) {
    		coleccionNueva.add(objeto.toString());
    	}
    	
    	arbolCadenas = coleccionNueva;
    }
    ...
    {
    	TreeSet<String> coleccionNueva = new TreeSet<String>(arbolCadenas.descendingSet().comparator());
    	for (String c : arbolCadenas.descendingSet()) {
    		coleccionNueva.add(c);
    	}
        return coleccionNueva;
    }
    ...
    public boolean compararElementos( String[] otroArreglo )
    {
        ...
        for(String c1 : otroArreglo) {
        	boolean existe = false;
        	for (String c2: arbolCadenas) {
        		if (c2.equals(c1)) {
        			existe = true;
        		}
        	} 
