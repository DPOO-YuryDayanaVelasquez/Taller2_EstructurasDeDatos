...
public class SandboxArreglos
{
    ...
    public void eliminarEntero( int valor )
    {
    	...
    	int[] arregloNuevo = new int[arregloEnteros.length-total_apariciones];
    	
    	for (int i=0, j=0; i<arregloEnteros.length; i++) {
    		if (arregloEnteros[i] != valor) {
    			arregloNuevo[j] = arregloEnteros[i];
    			j++;
    		}
    	}
    ...
    public void eliminarCadena( String cadena )
    {
    	...
    	String[] arregloNuevo = new String[arregloCadenas.length-total_apariciones];
    	
    	for (int i=0, j=0; i<arregloCadenas.length; i++) {
    		if (!arregloCadenas[i].equals(cadena)) {
    			arregloNuevo[j] = arregloCadenas[i]; 
    			j++;
    		}
    	}
    ...
    public void insertarEntero( int entero, int posicion )
    {
    	...
    	if (posicion<=0) {
    		arregloNuevo[0] = entero;
    		for (int i=0, j=1; i<arregloEnteros.length; i++, j++) {
    			arregloNuevo[j] = arregloEnteros[i];
    		}
    ...
    {    	
    	...
    	for(int i=0; i<arregloEnteros.length; i++) {
    		...
    		temporal = arregloEnteros[i];
    		arregloEnteros[i] = menor;
    		arregloEnteros[menorPosicion] = temporal;
    ...
    public void organizarCadenas( )
    {
    	...
    	for (int i=0; i<arregloCadenas.length; i++) {
    		...
    		temporal = arregloCadenas[i];
    		arregloCadenas[i] = menor;
    		arregloCadenas[menorPosicion] = temporal;
    	}
    }
    ...
    public int[] buscarEntero( int valor )
    {
    	...
    	int[] arregloPosiciones = new int[tamanio];
    ...
    public HashMap<Integer, Integer> calcularHistograma( )
    {
        ...
        for(int i=0; i<arregloEnteros.length; i++) {
        	...
        	if(!histograma.containsKey(arregloEnteros[i])) {
        		...
        		int valorActual = histograma.get(arregloEnteros[i]);
        		histograma.replace(arregloEnteros[i], valorActual+1);
        	}
        }
    ...
    public int contarEnterosRepetidos( )
    {
    	...
    	int repetidos = 0;
    	for(int llave : histograma.keySet()) {
    ...
    public boolean mismosEnteros( int[] otroArreglo )
    {
    	...
    	for(int i=0; i<arregloEnteros.length; i++) {
    		...
    		for (int j=0; j<otroArreglo.length; j++) {
    			if(otroArreglo[j] == arregloEnteros[i]) {
    				existe = true;
    			}
    		} 
    		if (!existe) {
